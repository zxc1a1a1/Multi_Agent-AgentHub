...
const (
	...
	defaultAgentDescription = "Analyze test logs, assess coverage, and perform root cause analysis."
...
func WithModel(m adk.Model) TestAgentOption {
...
func NewTestAgent(cfg Config, opts ...TestAgentOption) *TestAgent {
	...
	a := &TestAgent{name: name, description: description, version: version}
...
func (a *TestAgent) Generate(ctx context.Context, req *adk.GenerateRequest) (*adk.GenerateResponse, error) {
