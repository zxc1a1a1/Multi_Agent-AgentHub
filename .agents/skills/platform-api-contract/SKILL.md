...
description: "Gateway public API skill. Updated for Module Separation & Runtime Redesign."
---
...
Use this when changing browser-facing API. Frontend talks only to Gateway. /agui/runs is formal; /api/chat is temporary compatibility.
